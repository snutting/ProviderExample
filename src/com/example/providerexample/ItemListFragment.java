...
import com.example.providerexample.database.ItemProvider;
...
public class ItemListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new SimpleCursorAdapter(getActivity(),
				R.layout.item_listitem, null, new String[] {
                    Item.COL_ITEM_TITLE, Item.COL_COMPLETE,
                    Item.COL_DESC }, new int[] {R.id.cardTitle,
                    R.id.cardComplete, R.id.cardDescription}, 0));
